import 'dart:convert';
/// updated : 1665568368605
/// cases : 627816816
/// todayCases : 169047
/// deaths : 6564231
/// todayDeaths : 386
/// recovered : 607343061
/// todayRecovered : 196445
/// active : 13909524
/// critical : 38708
/// casesPerOneMillion : 80543
/// deathsPerOneMillion : 842.1
/// tests : 6732551615
/// testsPerOneMillion : 847401.86
/// population : 7944933753
/// oneCasePerPeople : 0
/// oneDeathPerPeople : 0
/// oneTestPerPeople : 0
/// activePerOneMillion : 1750.74
/// recoveredPerOneMillion : 76444.07
/// criticalPerOneMillion : 4.87
/// affectedCountries : 230

GetWorldData getWorldDataFromJson(String str) => GetWorldData.fromJson(json.decode(str));
String getWorldDataToJson(GetWorldData data) => json.encode(data.toJson());
class GetWorldData {
  GetWorldData({
      num? updated, 
      num? cases, 
  ...
  GetWorldData.fromJson(dynamic json) {
...
GetWorldData copyWith({  num? updated,
  num? cases,
  num? todayCases,
  num? deaths,
  num? todayDeaths,
  ...
  num? criticalPerOneMillion,
  num? affectedCountries,
}) => GetWorldData(  updated: updated ?? _updated,
  cases: cases ?? _cases,
